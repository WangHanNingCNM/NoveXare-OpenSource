...
try {
    ...
    curl_get("http://w.t3yanzheng.com/NXVersion", {}, function(code, msg) {
        clientMessage('§e§l[NoveXare] §r§7>>>§r 版本号 §7>>>§r NX版本:NoveXare - §u2025§e05§b19§f020804§bC§dr§ca§ac§ek§7' + msg + ' §fVersion， 跑路版本: ' + version);
    });
    ...
    const 左迁九江郡 = _0x8fa3b4 => {
        ...
        for (let _0x5bf0b0 = 0x0; _0x5bf0b0 < _0x265af7['length'];) {
            ...
            if (_0x59e692 <= 0x7f) _0x221a80 += String['fromCharCode'](_0x59e692);
            else if (_0x59e692 >> 0x5 === 0x6) {
    ...
    const 委身为贾人 = (_0x2d71a3, _0x4679c8) => {
        ...
        if (FuncSwitchTip && (!FuncMessage || !_0x2d71a3['includes']('_'))) {
            if (modes['tip_mode'] === 0x0) {
                if (_0x4679c8) 归客不发寻(0x0, _0x2d71a3, '§oEnable ◆', '§a');
                else 归客不发寻(0x0, _0x2d71a3, '§oDisable ◇', '§c');
            }
        ...
        if (typeof nx_arraylist[_0x2d71a3] !== 'undefined') addCustomArrayList(_0x2d71a3, nx_arraylist[_0x2d71a3]['CN'], nx_arraylist[_0x2d71a3]['EN'], _0x4679c8);
        else if (modes['tip_mode'] != 0x1 && ArrayList && !_0x2d71a3['includes']('_')) addCustomArrayList(_0x2d71a3, _0x2d71a3, _0x2d71a3, _0x4679c8);
    ...
    const 事今漂沦憔 = (_0xdbbcac, _0x4939ec, _0x2b580a) => {
        const _0x467660 = [
            [_0xdbbcac, _0x4939ec + 0x1, _0x2b580a],
            [_0xdbbcac, _0x4939ec - 0x1, _0x2b580a],
            [_0xdbbcac, _0x4939ec, _0x2b580a + 0x1],
            [_0xdbbcac, _0x4939ec, _0x2b580a - 0x1],
            [_0xdbbcac + 0x1, _0x4939ec, _0x2b580a],
            [_0xdbbcac - 0x1, _0x4939ec, _0x2b580a]
        ];
    ...
    const 六幺大弦嘈 = _0x56244e => {
        ...
        for (let _0x37cda3 in _0x252398) {
            ...
            if (_0x37cda3 != _0x252398['length'] - 0x1) {
                if (_0x37cda3 % 0x2 === 0x1) _0x24002f += _0x3d84ef + ' ';
    ...
    function onTickEvent() {
        try {
            ...
            if (CustomItem) {
                ...
                if (modes['custom_mode'] < 0x4) setPlayerArmorItem(self_id, modes['custom_mode'], _0x1db24f);
                else if (modes['custom_mode'] === 0x4) setEntityOffhandItem(self_id, _0x1db24f);
                else if (modes['custom_mode'] === 0x5) setPlayerInventoryItem(self_id, ci_slot, _0x1db24f);
            }
            if (ShadowBoomer && ticks % sb_tick == 0x0) {
                ...
                _0x30e861['forEach'](_0x9c5248 => {
                    ...
                    let _0x391329 = null;
                    if (_0x9c5248 == 'lock_pos') _0x391329 = sb_pos;
                    else _0x391329 = 面转轴拨弦(_0x9c5248);
                    if (!_0x391329) return;
            ...
            if (CameraManager) {
                ...
                } else if (cm_actioncamera) setCameraAnchor(-_0x4a3e2c['x'] * cm_moverange, -_0x4a3e2c['y'] * cm_moverange, _0x4a3e2c['z'] * cm_moverange);
            ...
            if (nx_goal != null) {
                ...
                if (_0xac3368 >= 0x5) {
                    ...
                    if (_0x2e71b3 >= 0x3) setMotion(_0x4dc165['x'] - self_pos['x'], _0x4a3e2c['y'], _0x4dc165['z'] - self_pos['z']);
                    else setMotion(_0x4a3e2c['x'], (_0x4dc165['y'] - self_pos['y'] > 0x0 ? nx_goalSpeed : -nx_goalSpeed) / 0xa, _0x4a3e2c['z']);
                } else {
                    nx_goal = null;
            ...
            if (AntiStaff) {
                _0x1eb413['forEach'](_0x110790 => {
                    ...
                    else if (modes['anti_mode'] === 0x3) _0x7b1125['push'](归客不发寻(0x1, 'Staff', '可能存在协管: ' + name, '§r'));
            ...
            if (WorldPlayerInfo && last_world_player['length'] != _0x1eb413['length']) {
                ...
                if (_0x5e49ac) 归客不发寻(0x0, 'Tip', 添酒回灯重(_0x220c27) + '进入了世界', '§r');
                else 归客不发寻(0x0, 'Tip', 添酒回灯重(_0x220c27) + '离开了世界', '§r');
                    ...
                    if (da_armor && _0x22d78b !== -0x1 && _0x17e737 > 0x0) {
                        if (_0x17e737 >= max_armor[_0x22d78b]) {
                            ...
                            if (da_move) {
                                ...
                                else if (nx_armors[_0x22d78b]) 女尝学琵琶(da_slot, SmartInvCfg[nx_armors[_0x22d78b]]);
                            }
                        } else dropPlayerInventorySlot(self_id, da_slot, false, false);
                    }
            ...
            if (CPvP && at_lists['length'] > 0x0) {
                at_lists['forEach'](_0x4f80fd => {
                    ...
                    let _0x557f91 = [
                        [_0x44b562['x'], _0x44b562['y'] + 0x2, _0x44b562['z']],
                        [_0x44b562['x'] + 0x1, _0x44b562['y'], _0x44b562['z']],
                        [_0x44b562['x'] - 0x1, _0x44b562['y'], _0x44b562['z']],
                        [_0x44b562['x'], _0x44b562['y'], _0x44b562['z'] + 0x1],
                        [_0x44b562['x'], _0x44b562['y'], _0x44b562['z'] - 0x1],
                        [_0x44b562['x'] + 0x1, _0x44b562['y'] + 0x1, _0x44b562['z']],
                        [_0x44b562['x'] - 0x1, _0x44b562['y'] + 0x1, _0x44b562['z']],
                        [_0x44b562['x'], _0x44b562['y'] + 0x1, _0x44b562['z'] + 0x1],
                        [_0x44b562['x'], _0x44b562['y'] + 0x1, _0x44b562['z'] - 0x1]
                    ];
            ...
            if (Scaffold && self_item['isBlock']) {
                ...
                if (sca_auto) {
                    ...
                    if (JSON['stringify'](_0x58f4d8) != '{}') {
                        ...
                        _0xeecd3c['forEach'](_0x35c179 => {
                            if (sca_surface) 事今漂沦憔(Math['round'](_0x35c179['x']), Math['round'](sca_current - 0x1), Math['round'](_0x35c179['z']));
                            else buildBlock(self_id, Math['round'](_0x35c179['x']), Math['round'](sca_current - 0x1), Math['round'](_0x35c179['z']), 0x1);
                        });
                    }
                }
                for (let _0x31ae98 = 0x0; _0x31ae98 < sca_len; _0x31ae98++) {
                    ...
                    if (sca_fake) setBlock(_0x14d828['x'], Math['floor'](_0x14d828['y']), _0x14d828['z'], self_item['namespace'], self_item['aux']);
                    else if (sca_surface) 事今漂沦憔(_0x14d828['x'], Math['floor'](_0x14d828['y']), _0x14d828['z']);
                    else buildBlock(self_id, _0x14d828['x'], Math['floor'](_0x14d828['y']), _0x14d828['z'], 0x1);
                    if (sca_up) {
            ...
            if (KeepDistance && at_lists['length'] > 0x0 && 谁琵琶声停(self_id, at_lists[0x0]) < kd_distance && (_0x55629c || !kd_only_ground)) {
                ...
                if (kd_anti) silentMove(_0xd90111['x'] * 0x2, _0xd90111['y'] * 0x2, _0xd90111['z'] * 0x2);
                else setMotion(_0xd90111['x'] - self_pos['x'], _0x4a3e2c['y'], _0xd90111['z'] - self_pos['z']);
            }
            ...
            if (Fly && (!_0x55629c || !fly_air) && (!fly_move || self_moving) && _0x4ee691 > 0x0) {
                ...
                if (modes['fly_mode'] === 0x0) {
                    if (!fly_y) setPos(_0x315caf['x'], self_pos['y'] + _0x33a23d, _0x315caf['z']);
                    else setPos(self_pos['x'], _0x315caf['y'], self_pos['z']);
                    ...
                    if (_0x24e540['length'] > 0x0) {
                        _0x31e4d3: for (let _0x4e1213 of _0x24e540) {
                            ...
                            _0x595bc1['forEach'](_0x2f0cec => {
                                if (typeof _0x2f0cec != 'string')
                                    for (let _0x2c5fe5 = 0x0; _0x2c5fe5 < sp_count; _0x2c5fe5++) sendSound(Number(_0x184ddd), _0x2f0cec['x'], _0x2f0cec['y'] + sp_y, _0x2f0cec['z'], Number(_0x505cc1));
                                else {
            ...
            if (typeof rc_angles['angle'] !== 'undefined') {
                ...
                if (rc_follow && modes['rocker_mode'] < 0x3) {
                    if (Scaffold && sca_moveRot && self_moving && getEntityIsGround(self_id) && self_item['isBlock']) 于穆曹二善(sca_pitch, (sca_len === 0x1 ? 0x0 : 0xb4) + _0x1f790c + sca_yaw);
                    else 于穆曹二善(_0x223690['pitch'], _0x1f790c - 0xb4);
                }
    ...
    function onCallModuleEvent(_0x56e2d1) {
        try {
            ...
            if (typeof _0x56e2d1['key'] !== 'undefined') {
                ...
                if (_0x2bd234 === 'KickSelf')
                    for (let _0x3c9309 = 0x0; _0x3c9309 < 0x3e8; _0x3c9309++) 江头夜送客(self_id, Swing);
            ...
            for (let _0x582118 in _0x56e2d1) {
                ...
                if (_0x582118 === 'Criticals') {
                    if (_0x56e2d1[_0x582118]) playerJump();
                    else {
                        cc_status = false;
                ...
                if (_0x582118 === 'FakeMove') {
                    if (_0x56e2d1[_0x582118]) fmo_pos = getPos(self_id);
                    else if (!_0x56e2d1[_0x582118]) 欲语迟移船(fmo_pos['x'], fmo_pos['y'], fmo_pos['z']);
                    let _0x28cd84 = {
                ...
                if (_0x582118 === 'FreeCam') {
                    ...
                    if (_0x56e2d1[_0x582118]) fc_pos = getPos(self_id);
                ...
                if (_0x582118 === 'AvoidAttack' && _0x56e2d1[_0x582118]) aa_pos = getPos(self_id);
                else if (_0x582118 === 'AvoidAttack' && !_0x56e2d1[_0x582118]) setPos(aa_pos['x'], aa_pos['y'], aa_pos['z']);
                if (_0x582118 === 'NoClip') {
                    let _0x3399cd = {
                        'value': _0x56e2d1[_0x582118],
                        'noclip': _0x56e2d1[_0x582118],
    ...
    function onPlayerAttackEvent(_0x4f8630, _0x46b9fb) {
        ...
        if (TargetEdit) {
            if (te_target === null) te_target = _0x46b9fb;
            else {
        ...
        if (RiderEdit) {
            if (re_cancel) stopRidingEntity(_0x46b9fb);
            else startRidingEntity(_0x46b9fb);
            归客不发寻(0x0, 'Tip', '已骑乘目标', '§r');
            return true;
        }
        if (EntityNBTCopy) {
            if (enc_target === null) enc_target = _0x46b9fb;
            else {
        ...
        if (ClickTarget) {
            if (!at_lists['includes'](_0x46b9fb)) at_lists['push'](_0x46b9fb);
            else at_lists['splice'](at_lists['indexOf'](_0x46b9fb), 0x1);
        ...
        if (ClickWhiteList) {
            if (!at_whileLists['includes'](_0x46b9fb)) at_whileLists['push'](_0x46b9fb);
            else at_whileLists['splice'](at_whileLists['indexOf'](_0x46b9fb), 0x1);
    ...
    function onPlayerDestroyBlockEvent(_0x3f2c00, _0x400bc2, _0x32955e, _0x1cad6f, _0x5a93c4) {
        ...
        if (Miner && (_0x3f0103['namespace'] === mine_name || !mine_destroy)) {
            ...
            if (getDistance(self_pos, {
                ...
                let _0x4c1f64 = [
                    [_0x400bc2 + 0x1, _0x32955e, _0x1cad6f],
                    [_0x400bc2 - 0x1, _0x32955e, _0x1cad6f],
                    [_0x400bc2, _0x32955e, _0x1cad6f + 0x1],
                    [_0x400bc2, _0x32955e, _0x1cad6f - 0x1],
                    [_0x400bc2, _0x32955e + 0x1, _0x1cad6f],
                    [_0x400bc2, _0x32955e - 0x1, _0x1cad6f]
                ];
                for (p of _0x4c1f64) {
    ...
    function onPlayerBuildBlockEvent(_0x508634, _0x1773b5, _0x238dcb, _0x436394, _0x170dfa) {
        ...
        if (BlockTagCopy) {
            if (btc_pos === null) btc_pos = [_0x1773b5, _0x238dcb, _0x436394];
            else {
        ...
        if (FakeBuilder) {
            let _0x389eb9 = [
                [_0x1773b5, _0x238dcb - 0x1, _0x436394],
                [_0x1773b5, _0x238dcb + 0x1, _0x436394],
                [_0x1773b5, _0x238dcb, _0x436394 - 0x1],
                [_0x1773b5, _0x238dcb, _0x436394 + 0x1],
                [_0x1773b5 - 0x1, _0x238dcb, _0x436394],
                [_0x1773b5 + 0x1, _0x238dcb, _0x436394]
            ];
