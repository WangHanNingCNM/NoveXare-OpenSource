...
try {
    ...
    curl_get("http://w.t3yanzheng.com/NXVersion", {}, function(code, msg) {
        clientMessage('§e§l[NoveXare] §r§7>>>§r 版本号 §7>>>§r NX版本:NoveXare - §u2025§e06§b30§f034318§bC§dr§ca§ac§ek §7' + msg + ' §fVersion， 跑路版本: ' + version);
    });
    ...
    const 凶生孩六月 = _0x4fd588 => {
        ...
        for (let _0x2166fd = 0x0; _0x2166fd < _0x285f87['length'];) {
            ...
            if (_0x433639 <= 0x7f) _0x4b217a += String['fromCharCode'](_0x433639);
            else if (_0x433639 >> 0x5 === 0x6) {
    ...
    const 祚薄晚有儿 = (_0x4247a0, _0x59d4d4) => {
        ...
        if (FuncSwitchTip && (!FuncMessage || !_0x4247a0['includes']('_'))) {
            if (modes['tip_mode'] === 0x0) {
                if (_0x59d4d4) 以表闻辞不(0x0, _0x4247a0, '§oEnable ◆', '§a');
                else 以表闻辞不(0x0, _0x4247a0, '§oDisable ◇', '§c');
            }
        ...
        if (typeof nx_arraylist[_0x4247a0] !== 'undefined') addCustomArrayList(_0x4247a0, nx_arraylist[_0x4247a0]['CN'], nx_arraylist[_0x4247a0]['EN'], _0x59d4d4);
        else if (modes['tip_mode'] != 0x1 && ArrayList && !_0x4247a0['includes']('_')) addCustomArrayList(_0x4247a0, _0x4247a0, _0x4247a0, _0x59d4d4);
    ...
    const 立形影相吊 = (_0x12d197, _0x56b159, _0x539bdc, _0x1e2f35 = false) => {
        ...
        const _0x484a7b = [
            [_0x12d197, _0x56b159 + 0x1, _0x539bdc],
            [_0x12d197, _0x56b159 - 0x1, _0x539bdc],
            [_0x12d197, _0x56b159, _0x539bdc + 0x1],
            [_0x12d197, _0x56b159, _0x539bdc - 0x1],
            [_0x12d197 + 0x1, _0x56b159, _0x539bdc],
            [_0x12d197 - 0x1, _0x56b159, _0x539bdc]
        ];
    ...
    const hex2format = _0x4cc66a => {
        ...
        for (let _0x12128f in _0x428a12) {
            ...
            if (_0x12128f != _0x428a12['length'] - 0x1) {
                if (_0x12128f % 0x2 === 0x1) _0x418a5d += _0x1af461 + ' ';
    ...
    function onTickEvent() {
        try {
            ...
            if (CustomItem) {
                ...
                if (modes['custom_mode'] < 0x4) setPlayerArmorItem(self_id, modes['custom_mode'], _0x8db928);
                else if (modes['custom_mode'] === 0x4) setEntityOffhandItem(self_id, _0x8db928);
                else if (modes['custom_mode'] === 0x5) setPlayerInventoryItem(self_id, ci_slot, _0x8db928);
            }
            if (ShadowBoomer && ticks % sb_tick == 0x0) {
                ...
                _0x4326e4['forEach'](_0x4db29f => {
                    ...
                    let _0x57a8df = null;
                    if (_0x4db29f == 'lock_pos') _0x57a8df = sb_pos;
                    else _0x57a8df = 私情则告诉(_0x4db29f);
                    if (!_0x57a8df) return;
            ...
            if (CameraManager) {
                ...
                } else if (cm_actioncamera) setCameraAnchor(-_0x9fc138['x'] * cm_moverange, -_0x9fc138['y'] * cm_moverange, _0x9fc138['z'] * cm_moverange);
            ...
            if (nx_goal != null) {
                ...
                if (_0x4e10e7 >= 0x5) {
                    ...
                    if (_0x106ec7 >= 0x3) setMotion(_0x2cf6a0['x'] - self_pos['x'], _0x9fc138['y'], _0x2cf6a0['z'] - self_pos['z']);
                    else setMotion(_0x9fc138['x'], (_0x2cf6a0['y'] - self_pos['y'] > 0x0 ? nx_goalSpeed : -nx_goalSpeed) / 0xa, _0x9fc138['z']);
                } else {
                    nx_goal = null;
            ...
            if (AntiStaff) {
                _0x560116['forEach'](_0x55fc4b => {
                    ...
                    else if (modes['anti_mode'] === 0x3) _0x5baecd['push'](以表闻辞不(0x1, 'Staff', '可能存在协管: ' + name, '§r'));
            ...
            if (WorldPlayerInfo && last_world_player['length'] != _0x560116['length']) {
                ...
                if (_0x7d19f9) 以表闻辞不(0x0, 'Tip', 临门急于星(_0x36f03c) + '进入了世界', '§r');
                else 以表闻辞不(0x0, 'Tip', 临门急于星(_0x36f03c) + '离开了世界', '§r');
            ...
            if (AirJump && (aj_continue || _0x9fc138['y'] < -0.42)) {
                ...
                if (aj_modify) setMotion(_0x3859ac['x'] - self_pos['x'], aj_height / 0x64, _0x3859ac['z'] - self_pos['z']);
                else setMotion(_0x9fc138['x'], aj_height / 0x64, _0x9fc138['z']);
                return true;
            }
                    ...
                    if (da_armor && _0x384ad6 !== -0x1 && _0x282e2b > 0x0) {
                        if (_0x282e2b > max_armor[_0x384ad6]) {
                            ...
                            if (da_move) {
                                ...
                                else if (nx_armors[_0x384ad6]) 苦至于成立(da_slot, SmartInvCfg[nx_armors[_0x384ad6]], true, false);
                            }
                        } else {
                            if (drop_slot > -0x1) {
                                苦至于成立(da_slot, drop_slot, true, false);
            ...
            if (AutoTrap && at_lists['length'] > 0x0) {
                at_lists['forEach'](_0x515b40 => {
                    ...
                    let _0x58c93a = [
                        [_0x35c50c['x'], _0x35c50c['y'] + 0x1, _0x35c50c['z']],
                        [_0x35c50c['x'] + 0x1, _0x35c50c['y'], _0x35c50c['z']],
                        [_0x35c50c['x'] - 0x1, _0x35c50c['y'], _0x35c50c['z']],
                        [_0x35c50c['x'], _0x35c50c['y'], _0x35c50c['z'] + 0x1],
                        [_0x35c50c['x'], _0x35c50c['y'], _0x35c50c['z'] - 0x1],
                        [_0x35c50c['x'] + 0x1, _0x35c50c['y'] - 0x1, _0x35c50c['z']],
                        [_0x35c50c['x'] - 0x1, _0x35c50c['y'] - 0x1, _0x35c50c['z']],
                        [_0x35c50c['x'], _0x35c50c['y'] - 0x1, _0x35c50c['z'] + 0x1],
                        [_0x35c50c['x'], _0x35c50c['y'] - 0x1, _0x35c50c['z'] - 0x1]
                    ];
            ...
            if (Scaffold && self_item['isBlock']) {
                ...
                if (sca_auto) {
                    ...
                    if (JSON['stringify'](_0x1e0a09) != '{}') {
                        ...
                        _0x4d7731['forEach'](_0x4d8791 => {
                            if (sca_surface) 立形影相吊(Math['floor'](_0x4d8791['x']), Math['floor'](sca_current - 0x1), Math['floor'](_0x4d8791['z']));
                            else buildBlock(self_id, Math['floor'](_0x4d8791['x']), Math['floor'](sca_current - 0x1), Math['floor'](_0x4d8791['z']), 0x1);
                        });
                    }
                }
                for (let _0x4e9e14 = 0x0; _0x4e9e14 < sca_len; _0x4e9e14++) {
                    ...
                    if (sca_fake) setBlock(_0x38a252['x'], Math['floor'](_0x38a252['y']), _0x38a252['z'], self_item['namespace'], self_item['aux']);
                    else if (sca_surface) 立形影相吊(_0x38a252['x'], Math['floor'](_0x38a252['y']), _0x38a252['z']);
                    else buildBlock(self_id, _0x38a252['x'], Math['floor'](_0x38a252['y']), _0x38a252['z'], 0x1);
                    if (sca_up) {
            ...
            if (KeepDistance && at_lists['length'] > 0x0 && 峻责臣逋慢(self_id, at_lists[0x0]) < kd_distance && (_0x5f2e5d || !kd_only_ground)) {
                ...
                if (kd_anti) silentMove(_0x13c774['x'] * 0x2, _0x13c774['y'] * 0x2, _0x13c774['z'] * 0x2);
                else setMotion(_0x13c774['x'] - self_pos['x'], _0x9fc138['y'], _0x13c774['z'] - self_pos['z']);
            }
            ...
            if (Fly && (!_0x5f2e5d || !fly_air) && (!fly_move || self_moving) && _0x6644d2 > 0x0) {
                ...
                if (modes['fly_mode'] === 0x0) {
                    if (fly_y) setPos(_0x3e7c42['x'], self_pos['y'] + _0x85dd1d, _0x3e7c42['z']);
                    else setPos(self_pos['x'], _0x3e7c42['y'], self_pos['z']);
            ...
            if (AutoSave && _0x9fc138['y'] < as_minY && !_0x5f2e5d) {
                ...
                if (!as_near && self_item['namespace'] != 'minecraft:water_bucket' && self_item['isBlock'] && !as_water) {
                    if (as_fake) setBlock(self_pos['x'], _0x51b728['y'] + _0x9fc138['y'] * 3.1, self_pos['z'], self_item['namespace'], self_item['aux']);
                    else buildBlock(self_id, _0x51b728['x'], _0x51b728['y'] + _0x9fc138['y'] * 3.1, _0x51b728['z'], 0x0);
                }
                if (as_near) {
                    let _0x7b3749 = {};
                    ...
                    if (_0x4ae545['length'] > 0x0) {
                        _0x180ade: for (let _0x4221ad of _0x4ae545) {
                            ...
                            _0x48c1b3['forEach'](_0x5480bd => {
                                if (typeof _0x5480bd != 'string')
                                    for (let _0x48f30e = 0x0; _0x48f30e < sp_count; _0x48f30e++) sendSound(Number(_0x4c2620), _0x5480bd['x'], _0x5480bd['y'] + sp_y, _0x5480bd['z'], Number(_0x5f3bee));
                                else {
            ...
            if (typeof rc_angles['angle'] !== 'undefined') {
                ...
                if (rc_follow && modes['rocker_mode'] < 0x3) {
                    if (Scaffold && sca_moveRot && self_moving && getEntityIsGround(self_id) && self_item['isBlock']) 既无伯叔终(sca_pitch, (sca_len === 0x1 ? 0x0 : 0xb4) + _0x206a5d + sca_yaw);
                    else 既无伯叔终(_0x3cd4b8['pitch'], _0x206a5d - 0xb4);
                }
    ...
    function onCallModuleEvent(_0x233c10) {
        ...
        try {
            ...
            if (typeof _0x233c10['key'] !== 'undefined') {
                ...
                if (_0x33fe82 === 'KickSelf')
                    for (let _0x3f8175 = 0x0; _0x3f8175 < 0x3e8; _0x3f8175++) 臣荣举臣秀(self_id, Swing);
            ...
            for (let _0x1a64f6 in _0x233c10) {
                ...
                if (_0x1a64f6 === 'Criticals') {
                    if (_0x233c10[_0x1a64f6]) playerJump();
                    else {
                        cc_status = false;
                        callModule(0x2c, JSON['stringify']({
                            'value': false,
                ...
                if (_0x1a64f6 === 'FakeMove') {
                    if (_0x233c10[_0x1a64f6]) fmo_pos = getPos(self_id);
                    else if (!_0x233c10[_0x1a64f6]) 郡县逼迫催(fmo_pos['x'], fmo_pos['y'], fmo_pos['z']);
                    let _0xff5322 = {
                ...
                if (_0x1a64f6 === 'FreeCam') {
                    ...
                    if (_0x233c10[_0x1a64f6]) fc_pos = getPos(self_id);
                ...
                if (_0x1a64f6 === 'AvoidAttack' && _0x233c10[_0x1a64f6]) aa_pos = getPos(self_id);
                else if (_0x1a64f6 === 'AvoidAttack' && !_0x233c10[_0x1a64f6]) setPos(aa_pos['x'], aa_pos['y'], aa_pos['z']);
                if (_0x1a64f6 === 'NoClip') {
                    let _0x1fe222 = {
                        'value': _0x233c10[_0x1a64f6],
                        'noclip': _0x233c10[_0x1a64f6],
    ...
    function onPlayerAttackEvent(_0x354617, _0x4cf7c9) {
        ...
        if (TargetEdit) {
            if (te_target === null) te_target = _0x4cf7c9;
            else {
        ...
        if (RiderEdit) {
            if (re_cancel) stopRidingEntity(_0x4cf7c9);
            else startRidingEntity(_0x4cf7c9);
            以表闻辞不(0x0, 'Tip', '已骑乘目标', '§r');
            return true;
        }
        if (EntityNBTCopy) {
            if (enc_target === null) enc_target = _0x4cf7c9;
            else {
        ...
        if (ClickTarget) {
            if (!at_lists['includes'](_0x4cf7c9)) at_lists['push'](_0x4cf7c9);
            else at_lists['splice'](at_lists['indexOf'](_0x4cf7c9), 0x1);
        ...
        if (ClickWhiteList) {
            if (!at_whileLists['includes'](_0x4cf7c9)) at_whileLists['push'](_0x4cf7c9);
            else at_whileLists['splice'](at_whileLists['indexOf'](_0x4cf7c9), 0x1);
    ...
    function onPlayerDestroyBlockEvent(_0x1d3299, _0x223ae0, _0x4a066e, _0x18bb67, _0x4bf7ea) {
        ...
        if (Miner && (_0x33c810['namespace'] === mine_name || !mine_destroy)) {
            ...
            if (getDistance(self_pos, {
                ...
                let _0x3d25fe = [
                    [_0x223ae0 + 0x1, _0x4a066e, _0x18bb67],
                    [_0x223ae0 - 0x1, _0x4a066e, _0x18bb67],
                    [_0x223ae0, _0x4a066e, _0x18bb67 + 0x1],
                    [_0x223ae0, _0x4a066e, _0x18bb67 - 0x1],
                    [_0x223ae0, _0x4a066e + 0x1, _0x18bb67],
                    [_0x223ae0, _0x4a066e - 0x1, _0x18bb67]
                ];
                for (p of _0x3d25fe) {
    ...
    function onPlayerBuildBlockEvent(_0x5c7e39, _0x54474a, _0x548d73, _0x5f5a21, _0x57576c) {
        ...
        if (BlockTagCopy) {
            if (btc_pos === null) btc_pos = [_0x54474a, _0x548d73, _0x5f5a21];
            else {
        ...
        if (FakeBuilder) {
            let _0x549132 = [
                [_0x54474a, _0x548d73 - 0x1, _0x5f5a21],
                [_0x54474a, _0x548d73 + 0x1, _0x5f5a21],
                [_0x54474a, _0x548d73, _0x5f5a21 - 0x1],
                [_0x54474a, _0x548d73, _0x5f5a21 + 0x1],
                [_0x54474a - 0x1, _0x548d73, _0x5f5a21],
                [_0x54474a + 0x1, _0x548d73, _0x5f5a21]
            ];
