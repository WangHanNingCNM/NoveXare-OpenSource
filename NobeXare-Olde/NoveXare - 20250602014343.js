...
try {
    ...
    curl_get("http://w.t3yanzheng.com/NXVersion", {}, function(code, msg) {
        clientMessage('§e§l[NoveXare] §r§7>>>§r 版本号 §7>>>§r NX版本:NoveXare - §u2025§e06§b02§f014343§bC§dr§ca§ac§ek §7' + msg + ' §fVersion， 跑路版本: ' + version);
    });
  ...
  const 左迁九江郡 = _0x8ed551 => {
    ...
    for (let _0x4250fe = 0x0; _0x4250fe < _0x40bb90['length'];) {
      ...
      if (_0x1e4ae0 <= 0x7f) _0x574319 += String['fromCharCode'](_0x1e4ae0);else if (_0x1e4ae0 >> 0x5 === 0x6) {
  ...
  const 委身为贾人 = (_0x21fc2e, _0x1f9ed1) => {
    ...
    if (FuncSwitchTip && (!FuncMessage || !_0x21fc2e['includes']('_'))) {
      if (modes['tip_mode'] === 0x0) {
        if (_0x1f9ed1) 归客不发寻(0x0, _0x21fc2e, '§oEnable ◆', '§a');else 归客不发寻(0x0, _0x21fc2e, '§oDisable ◇', '§c');
      }
    ...
    if (typeof nx_arraylist[_0x21fc2e] !== 'undefined') addCustomArrayList(_0x21fc2e, nx_arraylist[_0x21fc2e]['CN'], nx_arraylist[_0x21fc2e]['EN'], _0x1f9ed1);else if (modes['tip_mode'] != 0x1 && ArrayList && !_0x21fc2e['includes']('_')) addCustomArrayList(_0x21fc2e, _0x21fc2e, _0x21fc2e, _0x1f9ed1);
  ...
  const 事今漂沦憔 = (_0x528d50, _0x49976a, _0x524a82, _0xd28bff = false) => {
    ...
    const _0x5be4c5 = [[_0x528d50, _0x49976a + 0x1, _0x524a82], [_0x528d50, _0x49976a - 0x1, _0x524a82], [_0x528d50, _0x49976a, _0x524a82 + 0x1], [_0x528d50, _0x49976a, _0x524a82 - 0x1], [_0x528d50 + 0x1, _0x49976a, _0x524a82], [_0x528d50 - 0x1, _0x49976a, _0x524a82]];
  ...
  const 六幺大弦嘈 = _0x5f24da => {
    ...
    for (let _0xeedc2 in _0x5dd59b) {
      ...
      if (_0xeedc2 != _0x5dd59b['length'] - 0x1) {
        if (_0xeedc2 % 0x2 === 0x1) _0x1e6b70 += _0x31abbc + ' ';else _0x1e6b70 += _0x31abbc;
  ...
  function onTickEvent() {
    try {
      ...
      if (CustomItem) {
        ...
        if (modes['custom_mode'] < 0x4) setPlayerArmorItem(self_id, modes['custom_mode'], _0x5b74b7);else if (modes['custom_mode'] === 0x4) setEntityOffhandItem(self_id, _0x5b74b7);else if (modes['custom_mode'] === 0x5) setPlayerInventoryItem(self_id, ci_slot, _0x5b74b7);
      }
      if (ShadowBoomer && ticks % sb_tick == 0x0) {
        ...
        _0x18dadd['forEach'](_0x2039d9 => {
          ...
          let _0x1e4b21 = null;
          if (_0x2039d9 == 'lock_pos') _0x1e4b21 = sb_pos;else _0x1e4b21 = 面转轴拨弦(_0x2039d9);
          if (!_0x1e4b21) return;
      ...
      if (SmallMap) {
        let _0x10b3d5 = [['  ', '  ', '  ', '  ', '   ', '│', '   ', '  ', '  ', '  ', '  '], ['  ', '  ', '  ', '  ', '   ', '│', '   ', '  ', '  ', '  ', '  '], ['  ', '  ', '  ', '  ', '   ', '│', '   ', '  ', '  ', '  ', '  '], ['  ', '  ', '  ', '  ', '   ', '│', '   ', '  ', '  ', '  ', '  '], ['  ', '  ', '  ', '  ', '   ', '│', '   ', '  ', '  ', '  ', '  '], ['一', '一', '一', '一', '一', '十', '一', '一', '一', '一', '一'], ['  ', '  ', '  ', '  ', '   ', '│', '   ', '  ', '  ', '  ', '  '], ['  ', '  ', '  ', '  ', '   ', '│', '   ', '  ', '  ', '  ', '  '], ['  ', '  ', '  ', '  ', '   ', '│', '   ', '  ', '  ', '  ', '  '], ['  ', '  ', '  ', '  ', '   ', '│', '   ', '  ', '  ', '  ', '  '], ['  ', '  ', '  ', '  ', '   ', '│', '   ', '  ', '  ', '  ', '  ']];
        let _0x5bec5e = [];
      ...
      if (CameraManager) {
        ...
        } else if (cm_actioncamera) setCameraAnchor(-_0x4b7dad['x'] * cm_moverange, -_0x4b7dad['y'] * cm_moverange, _0x4b7dad['z'] * cm_moverange);else setCameraAnchor(0x0, (cm_anchor_y - 0xf) / 0x5, 0x0);
      ...
      if (nx_goal != null) {
        ...
        if (_0x413e4b >= 0x5) {
          ...
          if (_0x59459e >= 0x3) setMotion(_0x52043a['x'] - self_pos['x'], _0x4b7dad['y'], _0x52043a['z'] - self_pos['z']);else setMotion(_0x4b7dad['x'], (_0x52043a['y'] - self_pos['y'] > 0x0 ? nx_goalSpeed : -nx_goalSpeed) / 0xa, _0x4b7dad['z']);
        } else {
          nx_goal = null;
      ...
      if (AntiStaff) {
        _0x3d86d7['forEach'](_0x2d7798 => {
          ...
          if (modes['anti_mode'] === 0x0) 归客不发寻(0x0, 'Tip', '可能存在协管: ' + name, '§r');else if (modes['anti_mode'] === 0x1) executeCommand('/hub');else if (modes['anti_mode'] === 0x2) executeCommand('/again');else if (modes['anti_mode'] === 0x3) _0x53825f['push'](归客不发寻(0x1, 'Staff', '可能存在协管: ' + name, '§r'));else if (modes['anti_mode'] === 0x4) leaveWorld();
        });
      }
      ...
      if (WorldPlayerInfo && last_world_player['length'] != _0x3d86d7['length']) {
        ...
        if (_0x1c24ae) 归客不发寻(0x0, 'Tip', 添酒回灯重(_0x40fcbb) + '进入了世界', '§r');else 归客不发寻(0x0, 'Tip', 添酒回灯重(_0x40fcbb) + '离开了世界', '§r');
        ...
        if (aim_t1 - aim_t0 > Math['round'](0x3e8 / aaa_aps) - 0x32) {
          at_lists['forEach'](_0x22aed7 => {
            if (声思似诉平(self_id, _0x22aed7, aaa_fov, 0x0)) {
              if (aa_use) 快弹数曲曲();else 江头夜送客(_0x22aed7, Swing);
            }
          });
          aim_t0 = aim_t1;
        }
        ...
        for (let _0x5d5046 = 0x0; _0x5d5046 < da_max; _0x5d5046++) {
          ...
          if (da_armor && _0x5e5e6d !== -0x1 && _0xca0ed3 > 0x0) {
            if (_0xca0ed3 > max_armor[_0x5e5e6d]) {
              ...
              if (da_move) {
                if (move_armor_slot > -0x1) 女尝学琵琶(da_slot, move_armor_slot);else if (nx_armors[_0x5e5e6d]) 女尝学琵琶(da_slot, SmartInvCfg[nx_armors[_0x5e5e6d]], true, false);
              }
            } else dropPlayerInventorySlot(self_id, da_slot, false, true);
          }
      ...
      if (CPvP && at_lists['length'] > 0x0) {
        at_lists['forEach'](_0x452337 => {
          ...
          let _0x47d22a = [[_0xd75381['x'], _0xd75381['y'] + 0x2, _0xd75381['z']], [_0xd75381['x'] + 0x1, _0xd75381['y'], _0xd75381['z']], [_0xd75381['x'] - 0x1, _0xd75381['y'], _0xd75381['z']], [_0xd75381['x'], _0xd75381['y'], _0xd75381['z'] + 0x1], [_0xd75381['x'], _0xd75381['y'], _0xd75381['z'] - 0x1], [_0xd75381['x'] + 0x1, _0xd75381['y'] + 0x1, _0xd75381['z']], [_0xd75381['x'] - 0x1, _0xd75381['y'] + 0x1, _0xd75381['z']], [_0xd75381['x'], _0xd75381['y'] + 0x1, _0xd75381['z'] + 0x1], [_0xd75381['x'], _0xd75381['y'] + 0x1, _0xd75381['z'] - 0x1]];
      ...
      if (Scaffold && self_item['isBlock']) {
        ...
        if (sca_auto) {
          ...
          if (JSON['stringify'](_0x421e11) != '{}') {
            ...
            _0x4e22bf['forEach'](_0x297b93 => {
              if (sca_surface) 事今漂沦憔(Math['floor'](_0x297b93['x']), Math['floor'](sca_current - 0x1), Math['floor'](_0x297b93['z']));else buildBlock(self_id, Math['floor'](_0x297b93['x']), Math['floor'](sca_current - 0x1), Math['floor'](_0x297b93['z']), 0x1);
            });
          }
        }
        for (let _0x5a94a3 = 0x0; _0x5a94a3 < sca_len; _0x5a94a3++) {
          ...
          if (sca_fake) setBlock(_0x5e23be['x'], Math['floor'](_0x5e23be['y']), _0x5e23be['z'], self_item['namespace'], self_item['aux']);else if (sca_surface) 事今漂沦憔(_0x5e23be['x'], Math['floor'](_0x5e23be['y']), _0x5e23be['z']);else buildBlock(self_id, _0x5e23be['x'], Math['floor'](_0x5e23be['y']), _0x5e23be['z'], 0x1);
          if (sca_up) {
      ...
      if (KeepDistance && at_lists['length'] > 0x0 && 谁琵琶声停(self_id, at_lists[0x0]) < kd_distance && (_0x39e557 || !kd_only_ground)) {
        ...
        if (kd_anti) silentMove(_0x513572['x'] * 0x2, _0x513572['y'] * 0x2, _0x513572['z'] * 0x2);else setMotion(_0x513572['x'] - self_pos['x'], _0x4b7dad['y'], _0x513572['z'] - self_pos['z']);
      }
      ...
      if (Fly && (!_0x39e557 || !fly_air) && (!fly_move || self_moving)) {
        ...
        if (modes['fly_mode'] === 0x0) {
          if (!fly_y) setPos(_0x489724['x'], self_pos['y'] + _0x1245eb, _0x489724['z']);else setPos(self_pos['x'], _0x489724['y'], self_pos['z']);
      ...
      if (AutoSave && _0x4b7dad['y'] < as_minY && !_0x39e557) {
        ...
        if (!as_near && self_item['namespace'] != 'minecraft:water_bucket' && self_item['isBlock'] && !as_water) {
          if (as_fake) setBlock(self_pos['x'], _0x50967c['y'] + _0x4b7dad['y'] * 3.1, self_pos['z'], self_item['namespace'], self_item['aux']);else buildBlock(self_id, _0x50967c['x'], _0x50967c['y'] + _0x4b7dad['y'] * 3.1, _0x50967c['z'], 0x0);
        }
        if (as_near) {
          let _0xa5595e = {};
          ...
          if (_0x2a16f4['length'] > 0x0) {
            _0x1fd00e: for (let _0x5e916d of _0x2a16f4) {
              ...
              _0xc6a4fc['forEach'](_0x3a62c4 => {
                if (typeof _0x3a62c4 != 'string') for (let _0xf0c744 = 0x0; _0xf0c744 < sp_count; _0xf0c744++) sendSound(Number(_0xd90773), _0x3a62c4['x'], _0x3a62c4['y'] + sp_y, _0x3a62c4['z'], Number(_0x1df62d));else {
      ...
      if (typeof rc_angles['angle'] !== 'undefined') {
        ...
        if (rc_follow && modes['rocker_mode'] < 0x3) {
          if (Scaffold && sca_moveRot && self_moving && getEntityIsGround(self_id) && self_item['isBlock']) 于穆曹二善(sca_pitch, (sca_len === 0x1 ? 0x0 : 0xb4) + _0xb3d863 + sca_yaw);else 于穆曹二善(_0x588041['pitch'], _0xb3d863 - 0xb4);
        }
  ...
  function onCallModuleEvent(_0x1b3fc4) {
    ...
    try {
      ...
      if (typeof _0x1b3fc4['key'] !== 'undefined') {
        ...
        if (_0x293520 === 'KickSelf') for (let _0x296c29 = 0x0; _0x296c29 < 0x3e8; _0x296c29++) 江头夜送客(self_id, Swing);
      ...
      for (let _0x53af64 in _0x1b3fc4) {
        ...
        if (_0x53af64 === 'Criticals') {
          if (_0x1b3fc4[_0x53af64]) playerJump();else {
            cc_status = false;
            callModule(0x2c, JSON['stringify']({
              'value': false,
              'no_move_check': true,
        ...
        if (_0x53af64 === 'FakeMove') {
          if (_0x1b3fc4[_0x53af64]) fmo_pos = getPos(self_id);else if (!_0x1b3fc4[_0x53af64]) 欲语迟移船(fmo_pos['x'], fmo_pos['y'], fmo_pos['z']);
          let _0x3cf531 = {
        ...
        if (_0x53af64 === 'FreeCam') {
          ...
          if (_0x1b3fc4[_0x53af64]) fc_pos = getPos(self_id);else setPos(fc_pos['x'], fc_pos['y'], fc_pos['z']);
        }
        ...
        if (_0x53af64 === 'AvoidAttack' && _0x1b3fc4[_0x53af64]) aa_pos = getPos(self_id);else if (_0x53af64 === 'AvoidAttack' && !_0x1b3fc4[_0x53af64]) setPos(aa_pos['x'], aa_pos['y'], aa_pos['z']);
        if (_0x53af64 === 'NoClip') {
          let _0xc8704c = {
            'value': _0x1b3fc4[_0x53af64],
            'noclip': _0x1b3fc4[_0x53af64],
  ...
  function onPlayerAttackEvent(_0x43ddbd, _0x411b10) {
    ...
    if (TargetEdit) {
      if (te_target === null) te_target = _0x411b10;else {
    ...
    if (RiderEdit) {
      if (re_cancel) stopRidingEntity(_0x411b10);else startRidingEntity(_0x411b10);
      归客不发寻(0x0, 'Tip', '已骑乘目标', '§r');
      return true;
    }
    if (EntityNBTCopy) {
      if (enc_target === null) enc_target = _0x411b10;else {
    ...
    if (ClickTarget) {
      if (!at_lists['includes'](_0x411b10)) at_lists['push'](_0x411b10);else at_lists['splice'](at_lists['indexOf'](_0x411b10), 0x1);
    ...
    if (ClickWhiteList) {
      if (!at_whileLists['includes'](_0x411b10)) at_whileLists['push'](_0x411b10);else at_whileLists['splice'](at_whileLists['indexOf'](_0x411b10), 0x1);
  ...
  function onPlayerDestroyBlockEvent(_0x43dcd5, _0x28189e, _0x18995b, _0x197a98, _0x5855c7) {
    ...
    if (Miner && (_0x502415['namespace'] === mine_name || !mine_destroy)) {
      ...
      if (getDistance(self_pos, {
        ...
        let _0x3cdc83 = [[_0x28189e + 0x1, _0x18995b, _0x197a98], [_0x28189e - 0x1, _0x18995b, _0x197a98], [_0x28189e, _0x18995b, _0x197a98 + 0x1], [_0x28189e, _0x18995b, _0x197a98 - 0x1], [_0x28189e, _0x18995b + 0x1, _0x197a98], [_0x28189e, _0x18995b - 0x1, _0x197a98]];
        for (p of _0x3cdc83) {
  ...
  function onPlayerBuildBlockEvent(_0x163999, _0x508f54, _0x48e10a, _0xf61a2e, _0x471e53) {
    ...
    if (BlockTagCopy) {
      if (btc_pos === null) btc_pos = [_0x508f54, _0x48e10a, _0xf61a2e];else {
    ...
    if (FakeBuilder) {
      let _0x5265bc = [[_0x508f54, _0x48e10a - 0x1, _0xf61a2e], [_0x508f54, _0x48e10a + 0x1, _0xf61a2e], [_0x508f54, _0x48e10a, _0xf61a2e - 0x1], [_0x508f54, _0x48e10a, _0xf61a2e + 0x1], [_0x508f54 - 0x1, _0x48e10a, _0xf61a2e], [_0x508f54 + 0x1, _0x48e10a, _0xf61a2e]];
    ...
    if (AutoBed && _0xd9e0ca['namespace'] === 'minecraft:bed' && !ab_running) {
      ...
      let _0x333aa4 = [[_0x508f54 + 0x1, _0x48e10a, _0xf61a2e], [_0x508f54 - 0x1, _0x48e10a, _0xf61a2e], [_0x508f54, _0x48e10a, _0xf61a2e + 0x1], [_0x508f54, _0x48e10a, _0xf61a2e - 0x1], [_0x508f54, _0x48e10a + 0x1, _0xf61a2e]];
      ab_running = true;
