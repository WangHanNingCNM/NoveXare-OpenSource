...
try {
    ...
    curl_get("http://w.t3yanzheng.com/NXVersion", {}, function(code, msg) {
        clientMessage('§e§l[NoveXare] §r§7>>>§r 版本号 §7>>>§r NX版本:NoveXare - §u2025§e05§b17§f153217§bC§dr§ca§ac§ek§7' + msg + ' §fVersion， 跑路版本: ' + version);
    });
    ...
    const 左迁九江郡 = _0x3d5b14 => {
        ...
        for (let _0x34be27 = 0x0; _0x34be27 < _0xddee1b['length'];) {
            ...
            if (_0x52c025 <= 0x7f) _0xd1befd += String['fromCharCode'](_0x52c025);
            else if (_0x52c025 >> 0x5 === 0x6) {
    ...
    const 委身为贾人 = (_0x303acb, _0x4ee50c) => {
        ...
        if (FuncSwitchTip && (!FuncMessage || !_0x303acb['includes']('_'))) {
            if (modes['tip_mode'] === 0x0) {
                if (_0x4ee50c) 归客不发寻(0x0, _0x303acb, '§oEnable ◆', '§a');
                else 归客不发寻(0x0, _0x303acb, '§oDisable ◇', '§c');
            }
        ...
        if (typeof nx_arraylist[_0x303acb] !== 'undefined') addCustomArrayList(_0x303acb, nx_arraylist[_0x303acb]['CN'], nx_arraylist[_0x303acb]['EN'], _0x4ee50c);
        else if (modes['tip_mode'] != 0x1 && ArrayList && !_0x303acb['includes']('_')) addCustomArrayList(_0x303acb, _0x303acb, _0x303acb, _0x4ee50c);
    ...
    const 事今漂沦憔 = (_0x36c7a2, _0x485ca4, _0x34223e) => {
        const _0x5693a7 = [
            [_0x36c7a2, _0x485ca4 + 0x1, _0x34223e],
            [_0x36c7a2, _0x485ca4 - 0x1, _0x34223e],
            [_0x36c7a2, _0x485ca4, _0x34223e + 0x1],
            [_0x36c7a2, _0x485ca4, _0x34223e - 0x1],
            [_0x36c7a2 + 0x1, _0x485ca4, _0x34223e],
            [_0x36c7a2 - 0x1, _0x485ca4, _0x34223e]
        ];
    ...
    const 六幺大弦嘈 = _0x47c54f => {
        ...
        for (let _0x412b57 in _0x6449a7) {
            ...
            if (_0x412b57 != _0x6449a7['length'] - 0x1) {
                if (_0x412b57 % 0x2 === 0x1) _0x3ff041 += _0x35fdea + ' ';
    ...
    function onTickEvent() {
        try {
            ...
            if (CustomItem) {
                ...
                if (modes['custom_mode'] < 0x4) setPlayerArmorItem(self_id, modes['custom_mode'], _0x13d9fc);
                else if (modes['custom_mode'] === 0x4) setEntityOffhandItem(self_id, _0x13d9fc);
                else if (modes['custom_mode'] === 0x5) setPlayerInventoryItem(self_id, ci_slot, _0x13d9fc);
            }
            if (ShadowBoomer && ticks % sb_tick == 0x0) {
                ...
                _0x4a3841['forEach'](_0x25a82e => {
                    ...
                    let _0x3bd16f = null;
                    if (_0x25a82e == 'lock_pos') _0x3bd16f = sb_pos;
                    else _0x3bd16f = 面转轴拨弦(_0x25a82e);
                    if (!_0x3bd16f) return;
            ...
            if (CameraManager) {
                ...
                } else if (cm_actioncamera) setCameraAnchor(-_0x2a8344['x'] * cm_moverange, -_0x2a8344['y'] * cm_moverange, _0x2a8344['z'] * cm_moverange);
            ...
            if (nx_goal != null) {
                ...
                if (_0x29f200 >= 0x5) {
                    ...
                    if (_0x4efe5e >= 0x3) setMotion(_0x48ad19['x'] - self_pos['x'], _0x2a8344['y'], _0x48ad19['z'] - self_pos['z']);
                    else setMotion(_0x2a8344['x'], (_0x48ad19['y'] - self_pos['y'] > 0x0 ? nx_goalSpeed : -nx_goalSpeed) / 0xa, _0x2a8344['z']);
                } else {
                    nx_goal = null;
            ...
            if (AntiStaff) {
                _0x186700['forEach'](_0x2cf080 => {
                    ...
                    else if (modes['anti_mode'] === 0x3) _0x482098['push'](归客不发寻(0x1, 'Staff', '可能存在协管: ' + name, '§r'));
            ...
            if (WorldPlayerInfo && last_world_player['length'] != _0x186700['length']) {
                ...
                if (_0x2214f1) 归客不发寻(0x0, 'Tip', 添酒回灯重(_0x2d6c2c) + '进入了世界', '§r');
                else 归客不发寻(0x0, 'Tip', 添酒回灯重(_0x2d6c2c) + '离开了世界', '§r');
            ...
            if (CPvP && at_lists['length'] > 0x0) {
                at_lists['forEach'](_0x51e7b6 => {
                    ...
                    let _0xee8de3 = [
                        [_0x5302dd['x'], _0x5302dd['y'] + 0x2, _0x5302dd['z']],
                        [_0x5302dd['x'] + 0x1, _0x5302dd['y'], _0x5302dd['z']],
                        [_0x5302dd['x'] - 0x1, _0x5302dd['y'], _0x5302dd['z']],
                        [_0x5302dd['x'], _0x5302dd['y'], _0x5302dd['z'] + 0x1],
                        [_0x5302dd['x'], _0x5302dd['y'], _0x5302dd['z'] - 0x1],
                        [_0x5302dd['x'] + 0x1, _0x5302dd['y'] + 0x1, _0x5302dd['z']],
                        [_0x5302dd['x'] - 0x1, _0x5302dd['y'] + 0x1, _0x5302dd['z']],
                        [_0x5302dd['x'], _0x5302dd['y'] + 0x1, _0x5302dd['z'] + 0x1],
                        [_0x5302dd['x'], _0x5302dd['y'] + 0x1, _0x5302dd['z'] - 0x1]
                    ];
            ...
            if (Scaffold && self_item['isBlock']) {
                ...
                if (sca_auto) {
                    ...
                    if (JSON['stringify'](_0x3104c6) != '{}') {
                        ...
                        _0x2a69ea['forEach'](_0x22a796 => {
                            if (sca_surface) 事今漂沦憔(Math['round'](_0x22a796['x']), Math['round'](sca_current - 0x1), Math['round'](_0x22a796['z']));
                            else buildBlock(self_id, Math['round'](_0x22a796['x']), Math['round'](sca_current - 0x1), Math['round'](_0x22a796['z']), 0x1);
                        });
                    }
                }
                for (let _0x3eae15 = 0x0; _0x3eae15 < sca_len; _0x3eae15++) {
                    ...
                    if (sca_fake) setBlock(_0x21baf6['x'], Math['floor'](_0x21baf6['y']), _0x21baf6['z'], self_item['namespace'], self_item['aux']);
                    else if (sca_surface) 事今漂沦憔(_0x21baf6['x'], Math['floor'](_0x21baf6['y']), _0x21baf6['z']);
                    else buildBlock(self_id, _0x21baf6['x'], Math['floor'](_0x21baf6['y']), _0x21baf6['z'], 0x1);
                    if (sca_up) {
            ...
            if (KeepDistance && at_lists['length'] > 0x0 && 谁琵琶声停(self_id, at_lists[0x0]) < kd_distance && (_0x1418ab || !kd_only_ground)) {
                ...
                if (kd_anti) silentMove(_0x488587['x'] * 0x2, _0x488587['y'] * 0x2, _0x488587['z'] * 0x2);
                else setMotion(_0x488587['x'] - self_pos['x'], _0x2a8344['y'], _0x488587['z'] - self_pos['z']);
            }
                    ...
                    if (_0x37907b['length'] > 0x0) {
                        _0x1e86f8: for (let _0x21ba76 of _0x37907b) {
                            ...
                            _0x73dc4['forEach'](_0x2bbb91 => {
                                if (typeof _0x2bbb91 != 'string')
                                    for (let _0x2a440e = 0x0; _0x2a440e < sp_count; _0x2a440e++) sendSound(Number(_0x351a5f), _0x2bbb91['x'], _0x2bbb91['y'] + sp_y, _0x2bbb91['z'], Number(_0x109c38));
                                else {
            ...
            if (typeof rc_angles['angle'] !== 'undefined') {
                ...
                if (rc_follow && modes['rocker_mode'] < 0x3) {
                    if (Scaffold && sca_moveRot && self_moving && getEntityIsGround(self_id) && self_item['isBlock']) 于穆曹二善(sca_pitch, (sca_len === 0x1 ? 0x0 : 0xb4) + _0x10735c + sca_yaw);
                    else 于穆曹二善(_0x5610cd['pitch'], _0x10735c - 0xb4);
                }
    ...
    function onCallModuleEvent(_0x4c120a) {
        try {
            ...
            if (typeof _0x4c120a['key'] !== 'undefined') {
                ...
                if (_0x101669 === 'KickSelf')
                    for (let _0x1a63ac = 0x0; _0x1a63ac < 0x3e8; _0x1a63ac++) 江头夜送客(self_id, Swing);
            ...
            for (let _0x3a28c6 in _0x4c120a) {
                ...
                if (_0x3a28c6 === 'Criticals') {
                    if (_0x4c120a[_0x3a28c6]) playerJump();
                    else {
                        cc_status = false;
                ...
                if (_0x3a28c6 === 'FakeMove') {
                    if (_0x4c120a[_0x3a28c6]) fmo_pos = getPos(self_id);
                    else if (!_0x4c120a[_0x3a28c6]) 欲语迟移船(fmo_pos['x'], fmo_pos['y'], fmo_pos['z']);
                    let _0x7a2beb = {
                ...
                if (_0x3a28c6 === 'FreeCam') {
                    ...
                    if (_0x4c120a[_0x3a28c6]) fc_pos = getPos(self_id);
                ...
                if (_0x3a28c6 === 'AvoidAttack' && _0x4c120a[_0x3a28c6]) aa_pos = getPos(self_id);
                else if (_0x3a28c6 === 'AvoidAttack' && !_0x4c120a[_0x3a28c6]) setPos(aa_pos['x'], aa_pos['y'], aa_pos['z']);
                if (_0x3a28c6 === 'NoClip') {
                    let _0x51732f = {
                        'value': _0x4c120a[_0x3a28c6],
                        'noclip': _0x4c120a[_0x3a28c6],
    ...
    function onPlayerAttackEvent(_0x13d0f8, _0x4af2d1) {
        ...
        if (TargetEdit) {
            if (te_target === null) te_target = _0x4af2d1;
            else {
        ...
        if (RiderEdit) {
            if (re_cancel) stopRidingEntity(_0x4af2d1);
            else startRidingEntity(_0x4af2d1);
            归客不发寻(0x0, 'Tip', '已骑乘目标', '§r');
            return true;
        }
        if (EntityNBTCopy) {
            if (enc_target === null) enc_target = _0x4af2d1;
            else {
        ...
        if (ClickTarget) {
            if (!at_lists['includes'](_0x4af2d1)) at_lists['push'](_0x4af2d1);
            else at_lists['splice'](at_lists['indexOf'](_0x4af2d1), 0x1);
        ...
        if (ClickWhiteList) {
            if (!at_whileLists['includes'](_0x4af2d1)) at_whileLists['push'](_0x4af2d1);
            else at_whileLists['splice'](at_whileLists['indexOf'](_0x4af2d1), 0x1);
    ...
    function onPlayerDestroyBlockEvent(_0x359e9d, _0x5a0539, _0x1012b3, _0x70cabf, _0x119276) {
        ...
        if (Miner && (_0x4b041c['namespace'] === mine_name || !mine_destroy)) {
            ...
            if (getDistance(self_pos, {
                ...
                let _0x28a660 = [
                    [_0x5a0539 + 0x1, _0x1012b3, _0x70cabf],
                    [_0x5a0539 - 0x1, _0x1012b3, _0x70cabf],
                    [_0x5a0539, _0x1012b3, _0x70cabf + 0x1],
                    [_0x5a0539, _0x1012b3, _0x70cabf - 0x1],
                    [_0x5a0539, _0x1012b3 + 0x1, _0x70cabf],
                    [_0x5a0539, _0x1012b3 - 0x1, _0x70cabf]
                ];
                for (p of _0x28a660) {
    ...
    function onPlayerBuildBlockEvent(_0x2c7435, _0x694599, _0x2b9cdc, _0x322892, _0x1fa053) {
        ...
        if (BlockTagCopy) {
            if (btc_pos === null) btc_pos = [_0x694599, _0x2b9cdc, _0x322892];
            else {
        ...
        if (FakeBuilder) {
            let _0x5e1cd0 = [
                [_0x694599, _0x2b9cdc - 0x1, _0x322892],
                [_0x694599, _0x2b9cdc + 0x1, _0x322892],
                [_0x694599, _0x2b9cdc, _0x322892 - 0x1],
                [_0x694599, _0x2b9cdc, _0x322892 + 0x1],
                [_0x694599 - 0x1, _0x2b9cdc, _0x322892],
                [_0x694599 + 0x1, _0x2b9cdc, _0x322892]
            ];
